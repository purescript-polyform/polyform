...
type Dual m err = Tokenized.Dual.Dual (Validator.Validator m err) Identity

type DualD m err = Tokenized.Dual.DualD (Validator.Validator m err) Identity
...
runSerializer ∷ ∀ err i o m. Applicative m ⇒ Dual m err i o → (o → List i)
runSerializer = map (un Identity) <<< Tokenized.Dual.serializer
