...
--    import Data.Validation.Polyform.Validation.Field as FV
...
--
--    inputForm'
--      ∷ ∀ attrs e form m n q q' o v
--      . Monad m
--      ⇒ Monoid form
--      ⇒ (Record (name ∷ SProxy n, value ∷ Either e v | attrs) → form)
--      → Record (name ∷ SProxy n, value ∷ Either e v | attrs)
--      → FV.FieldValidation m e q' v
--      → { string ∷ SProxy n → FV.FieldValidation m e q q' | o }
--      → Form.Form m form q v
--    inputForm' singleton field validation source =
--      Form.inputForm singleton field (source.string field.name >>> validation)
--
--
...
--
--    string :: forall a e eff n q. SProxy n → FieldValidation.FieldValidation (Run (string ∷ STRING n q e a | eff)) e q String
--    string name = FieldValidation.FieldValidation $ Star \q → ExceptT (Run.lift _string (StringF name q id))
--
--    inputForm''' ∷ forall attrs e eff form q n v n
...
--      Form.inputForm singleton field $ string field.name >>> validation
--
--    -- inputForm'
--    --   ∷ ∀ attrs e form m n q r v
--    --   . Monad m
--    --   ⇒ (Record (name ∷ SProxy n, value ∷ Either e v | attrs))
--    --   → FieldValidation.FieldValidation m e q v
--    --   → Run
--    --     (form ∷ FORM form (Record (name ∷ SProxy n, value ∷ Either e v | attrs)) | r)
--    --     (form (Record (name ∷ SProxy n, value ∷ Either e v | attrs)))
--    -- inputForm' field _ = do
--    --   form field
--
--
--    inputForm
