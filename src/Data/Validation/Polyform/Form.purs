...
-- 
-- coproductChoiceForm ∷ ∀ a e q rep m
--   . Monad m
--   ⇒ Generic a rep
--   ⇒ Options rep
--   ⇒ String
--   → Proxy a
--   → FieldValidation m (Variant (invalidOption ∷ String | e)) (Maybe q) String
--   → Validation m (Form (Choice (Variant (invalidOption ∷ String | e)) a)) (Maybe q) a
